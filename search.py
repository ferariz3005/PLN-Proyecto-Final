...
'''
After running the python file make sure to make sure you're in the folder/directory where both the file 
and dataset are located. Once you've done this, you can launch the Streamlit interface by using the 
command 'streamlit run search.py' .
'''
